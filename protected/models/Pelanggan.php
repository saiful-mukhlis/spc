...
class Pelanggan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama, notelp', 'length', 'max'=>100),
			array('alamat', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, nama, alamat, notelp, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pelayanans' => array(self::HAS_MANY, 'Pelayanan', 'pelangganid'),
		);
	}
