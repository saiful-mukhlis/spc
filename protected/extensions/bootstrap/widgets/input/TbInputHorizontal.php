...
class TbInputHorizontal extends TbInput
{
	...
	protected function fileField()
	{
		...
		echo '<div class="controls">';
        // tambahan
        echo '<div class="span6 fileupload fileupload-new" data-provides="fileupload"><div class="fileupload-preview thumbnail" style="width: 97%; height: 150px;"></div><div><span class="btn btn-file"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span>';
		echo $this->form->fileField($this->model, $this->attribute, $this->htmlOptions);
        echo '</span><a href="#" class="btn fileupload-exists" data-dismiss="fileupload">Remove</a></div></div>';
		echo $this->getError() . $this->getHint();
		echo '</div>';
	}
